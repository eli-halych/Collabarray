...
<html lang="en">
<head>
    <title>Code coverage report for req-then/index.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">all files</a> / <a href="index.html">req-then/</a> index.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
  ...
  const req = transport.request(reqOptions, function (res) {
    ...
    streamReadAll(res).then(data =&gt; {
      ...
      <span class="missing-if-branch" title="else path not taken" >E</span>if (res.statusCode !== 0) {
...
&nbsp;
  req.on('error', <span class="fstat-no" title="function not covered" >function reqOnError (err) {</span>
    /* failed to connect */
<span class="cstat-no" title="statement not covered" >    err.name = 'request-fail'</span>
...
&nbsp;
  req.end(data)
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (reqOptions.controller) {
<span class="cstat-no" title="statement not covered" >    reqOptions.controller.abort = <span class="fstat-no" title="function not covered" >function () {</span></span>
<span class="cstat-no" title="statement not covered" >      req.abort()</span>
<span class="cstat-no" title="statement not covered" >      const err = new Error('Aborted')</span>
<span class="cstat-no" title="statement not covered" >      err.name = 'aborted'</span>
<span class="cstat-no" title="statement not covered" >      deferred.reject(err)</span>
    }
  }
&nbsp;
