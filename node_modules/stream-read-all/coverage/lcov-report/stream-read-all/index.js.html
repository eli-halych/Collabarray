...
<html lang="en">
<head>
    <title>Code coverage report for stream-read-all/index.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">all files</a> / <a href="index.html">stream-read-all/</a> index.js
    </h1>
    <div class='clearfix'>
...
class StreamReader extends Transform {
  constructor (options) {
    ...
    if (this.options.objectMode) {
      ...
      this.buf = Buffer.alloc ? Buffer.alloc(0) : <span class="branch-1 cbranch-no" title="branch not covered" >new Buffer(0)</span>
    }
  }
&nbsp;
  _transform (chunk, enc, done) {
    <span class="missing-if-branch" title="else path not taken" >E</span>if (chunk) {
      if (this.options.objectMode) {
        this.buf.push(chunk)
      } else {
