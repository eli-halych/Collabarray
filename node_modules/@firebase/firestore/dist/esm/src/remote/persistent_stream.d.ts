...
export declare abstract class PersistentStream<SendType, ReceiveType, ListenerType extends PersistentStreamListener> {
    ...
    private state;
    protected stream: Stream<SendType, ReceiveType> | null;
    protected backoff: ExponentialBackoff;
    protected listener: ListenerType | null;
    constructor(queue: AsyncQueue, connection: Connection, credentialsProvider: CredentialsProvider, listener: ListenerType, initialBackoffDelay?: number);
    /**
...
export declare class PersistentListenStream extends PersistentStream<api.ListenRequest, api.ListenResponse, WatchStreamListener> {
    ...
    private serializer;
    constructor(databaseInfo: DatabaseInfo, queue: AsyncQueue, connection: Connection, credentials: CredentialsProvider, serializer: JsonProtoSerializer, listener: WatchStreamListener, initialBackoffDelay?: number);
...
export declare class PersistentWriteStream extends PersistentStream<api.WriteRequest, api.WriteResponse, WriteStreamListener> {
    ...
    constructor(databaseInfo: DatabaseInfo, queue: AsyncQueue, connection: Connection, credentials: CredentialsProvider, serializer: JsonProtoSerializer, listener: WriteStreamListener, initialBackoffDelay?: number);
    /**
