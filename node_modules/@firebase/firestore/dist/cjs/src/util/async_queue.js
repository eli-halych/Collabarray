...
var AsyncQueue = /** @class */ (function () {
    ...
    AsyncQueue.prototype.schedule = function (op, delay) {
        var _this = this;
        if (this.failure) {
            assert_1.fail('AsyncQueue is already failed: ' + this.failure.message);
        }
        if ((delay || 0) > 0) {
            this.delayedOpCount++;
            var deferred_1 = new promise_1.Deferred();
            setTimeout(function () {
    ...
    AsyncQueue.prototype.drain = function () {
        ...
        assert_1.assert(this.delayedOpCount === 0, "draining doesn't handle delayed ops.");
